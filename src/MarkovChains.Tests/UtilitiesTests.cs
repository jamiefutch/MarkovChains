...
public class UtilitiesTests
{
    ...
    {
        var method = typeof(Utilities)
            .GetMethod("CleanAndSplitTokenizer", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static);

        if (method == null)
            throw new InvalidOperationException("CleanAndSplitTokenizer method not found.");
    ...
    {
        var method = typeof(Utilities)
            .GetMethod("CleanAndSplitTokenizerToList", System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Static);

        if (method == null)
            throw new InvalidOperationException("CleanAndSplitTokenizerToList method not found.");
